...
(function () {
	...
	b.urls[0]){l("css");break}h+=1;b&&(h<200?setTimeout(t,50):l("css"))}}var c,s,m={},h=0,n={css:[],js:[]},v=k.styleSheets;return{css:function(b,a,c,f){j("css",b,a,c,f)},js:function(b,a,c,f){j("js",b,a,c,f)}}}(document);
	...
	// Load project CSS
	LazyLoad.css( '<%= projectUrl %><%= versionDir %>styles/min.css' );
